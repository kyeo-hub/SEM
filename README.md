...
本项目是武汉钢铁集团物流有限公司的设备点检管理系统，用于将传统纸质点检本电子化，实现设备点检、状态监控、故障管理、作业跟踪的完整数字化流程。
...
| 📊 **统计分析** | 日报/周报/月报，合规率、故障分析 |
| 📱 **H5 移动端** | 手机浏览器扫码点检、状态变更、维保登记 |
| 🖥️ **大屏展示** | 实时设备状态、作业信息、告警滚动 |
...
- `GET /api/inspections/today` - 今日点检情况
